...
CREATE INDEX domains_traffic_score_idx ON domains (traffic_score DESC NULLS LAST);
CREATE INDEX domains_domain_gin_idx ON domains USING gin (domain gin_trgm_ops);
